...
public class CpuCore implements CgroupCore {
    private static final Logger logger = LoggerFactory.getLogger(CpuCore.class);
    ...
    public int getCpuShares() throws IOException {
        logger.debug("Getting CPU property {} from dir {}.", CPU_SHARES, this.dir);
    ...
    public void setCpuShares(int weight) throws IOException {
        logger.debug("Write CPUShares {} into dir: {}", weight, this.dir);
    ...
    public Long getCpuCfsPeriodUs() throws IOException {
        logger.debug("Getting CPU property {} from dir {}.", CPU_CFS_PERIOD_US, this.dir);
    ...
    public void setCpuCfsPeriodUs(long us) throws IOException {
        logger.debug("Setting CPU property {} at dir {}.", CPU_CFS_PERIOD_US, this.dir);
    ...
    public Long getCpuCfsQuotaUs() throws IOException {
        logger.debug("Getting CPU property {} from dir {}.", CPU_CFS_QUOTA_US, this.dir);
    ...
    public void setCpuCfsQuotaUs(long us) throws IOException {
        logger.debug("Setting CPU property {} at dir {}.", CPU_CFS_QUOTA_US, this.dir);
