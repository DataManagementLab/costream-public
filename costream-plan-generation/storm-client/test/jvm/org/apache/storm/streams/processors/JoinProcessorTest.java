...
public class JoinProcessorTest {
    ...
    public void testInnerJoin1() throws Exception {
        ...
        assertEquals(Pair.of(2, Pair.of(5, 8)), res.get(1));
        assertEquals(Pair.of(5, Pair.of(25, 125)), res.get(2));
    }

    @Test
    public void testInnerJoin2() throws Exception {
        joinProcessor = new JoinProcessor<>(rightStream, leftStream, new PairValueJoiner<>());
        processValues();
        assertEquals(Pair.of(2, Pair.of(8, 4)), res.get(0));
        assertEquals(Pair.of(2, Pair.of(8, 5)), res.get(1));
        assertEquals(Pair.of(5, Pair.of(125, 25)), res.get(2));
    }

    @Test
    public void testLeftOuterJoin() throws Exception {
        joinProcessor = new JoinProcessor<>(leftStream, rightStream, new PairValueJoiner<>(),
                                            JoinProcessor.JoinType.OUTER, JoinProcessor.JoinType.INNER, new HashMap<>());
        processValues();
        assertEquals(Pair.of(2, Pair.of(4, 8)), res.get(0));
        assertEquals(Pair.of(2, Pair.of(5, 8)), res.get(1));
        assertEquals(Pair.of(5, Pair.of(25, 125)), res.get(2));
        assertEquals(Pair.of(7, Pair.of(49, null)), res.get(3));
    }

    @Test
    public void testRightOuterJoin() throws Exception {
        joinProcessor = new JoinProcessor<>(leftStream, rightStream, new PairValueJoiner<>(),
                                            JoinProcessor.JoinType.INNER, JoinProcessor.JoinType.OUTER, new HashMap<>());
        processValues();
        assertEquals(Pair.of(2, Pair.of(4, 8)), res.get(0));
        assertEquals(Pair.of(2, Pair.of(5, 8)), res.get(1));
        assertEquals(Pair.of(5, Pair.of(25, 125)), res.get(2));
        assertEquals(Pair.of(1, Pair.of(null, 1)), res.get(3));
        assertEquals(Pair.of(6, Pair.of(null, 216)), res.get(4));
    }

    @Test
    public void testFullOuterJoin() throws Exception {
        joinProcessor = new JoinProcessor<>(leftStream, rightStream, new PairValueJoiner<>(),
                                            JoinProcessor.JoinType.OUTER, JoinProcessor.JoinType.OUTER, new HashMap<>());
        processValues();
        assertEquals(Pair.of(2, Pair.of(4, 8)), res.get(0));
        assertEquals(Pair.of(2, Pair.of(5, 8)), res.get(1));
        assertEquals(Pair.of(5, Pair.of(25, 125)), res.get(2));
        assertEquals(Pair.of(7, Pair.of(49, null)), res.get(3));
        assertEquals(Pair.of(1, Pair.of(null, 1)), res.get(4));
        assertEquals(Pair.of(6, Pair.of(null, 216)), res.get(5));
    }
