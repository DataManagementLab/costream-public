...
public class DaemonConfig implements Validated {
    ...
    /**
     * the manually set swap limit (in MB) for each CGroup on supervisor node.
     */
    @IsPositiveNumber
    public static String STORM_WORKER_CGROUP_SWAP_MB_LIMIT = "storm.worker.cgroup.swap.mb.limit";
    /**
