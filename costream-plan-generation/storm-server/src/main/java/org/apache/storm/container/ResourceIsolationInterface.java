...
public interface ResourceIsolationInterface {
     ...
     * @param totalMemory     the amount of memory for the worker or null if not enforced
     * @param totalMemAndSwap the amount of memory + swap for the worker of null if not enforced
     * @param totalCpu        the amount of cpu for the worker or null if not enforced
     * @param cpuShares       the amount of cpuShares for the worker or null if not enforced
