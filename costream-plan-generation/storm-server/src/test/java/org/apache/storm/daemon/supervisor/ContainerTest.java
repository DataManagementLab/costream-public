...
public class ContainerTest {
    ...
    public static class MockResourceIsolationManager implements ResourceIsolationInterface {
        ...
        @Override
        public void reserveResourcesForWorker(String workerId, Integer totalMemory, Integer totalMemAndSwap, Integer totalCpu, Integer cpuShares,
                                              Integer majorClassId, Integer minorClassId, String numaId) {
            fail("THIS IS NOT UNDER TEST");
        }
