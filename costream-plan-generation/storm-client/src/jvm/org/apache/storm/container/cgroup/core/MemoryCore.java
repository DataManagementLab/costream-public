...
public class MemoryCore implements CgroupCore {
    private static final Logger logger = LoggerFactory.getLogger(MemoryCore.class);
    ...
    public long getPhysicalUsage() throws IOException {
        logger.debug("Getting memory property {} from dir {}.", MEMORY_USAGE_IN_BYTES, this.dir);
    ...
    public long getWithSwapUsage() throws IOException {
        logger.debug("Getting memory property {} from dir {}.", MEMORY_MEMSW_USAGE_IN_BYTES, this.dir);
    ...
    public long getMaxPhysicalUsage() throws IOException {
        logger.debug("Getting memory property {} from dir {}.", MEMORY_MAX_USAGE_IN_BYTES, this.dir);
    ...
    public long getMaxWithSwapUsage() throws IOException {
        logger.debug("Getting memory property {} from dir {}.", MEMORY_MEMSW_MAX_USAGE_IN_BYTES, this.dir);
    ...
    public long getPhysicalUsageLimit() throws IOException {
        logger.debug("Getting memory property {} from dir {}.", MEMORY_LIMIT_IN_BYTES, this.dir);
    ...
    public void setPhysicalUsageLimit(long value) throws IOException {
        logger.debug("Setting memory limit {} to dir: {}", value, this.dir);
        CgroupUtils.writeFileByLine(CgroupUtils.getDir(this.dir, MEMORY_LIMIT_IN_BYTES), String.valueOf(value));
    }

    public long getWithSwapLimit() throws IOException {
        logger.debug("Getting memory property {} from dir {}.", MEMORY_MEMSW_LIMIT_IN_BYTES, this.dir);
    ...
    public void setWithSwapUsageLimit(long value) throws IOException {
        logger.debug("Setting memory limit {} with swap to dir: {}", value, this.dir);
