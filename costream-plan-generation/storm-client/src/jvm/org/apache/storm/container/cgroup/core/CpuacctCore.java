...
public class CpuacctCore implements CgroupCore {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CpuacctCore.class);
    ...
    public Long getCpuUsage() throws IOException {
        logger.info("Getting cpuacct property {} from dir {}.", CPUACCT_USAGE, this.dir);
    ...
    public Map<StatType, Long> getCpuStat() throws IOException {
        logger.info("Getting cpuacct property {} from dir {}.", CPUACCT_STAT, this.dir);
    ...
    public Long[] getPerCpuUsage() throws IOException {
        logger.info("Getting cpuacct property {} from dir {}.", CPUACCT_USAGE_PERCPU, this.dir);
